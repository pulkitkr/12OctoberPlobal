...
//	}
	...
	public List<WebElement> findElements(By byLocator) {
		if (getPlatform().equals("Android") || getPlatform().equals("MPWA") || getPlatform().equals("GCash_iOS")) {
...
//			softAssert.assertAll();
	...
	public void SwipeHashtagRail(By From) throws Exception {
		...
		touchAction.press(PointOption.point(currentPosX, currentPosY))
				...
				.moveTo(PointOption.point(100, currentPosY)).release().perform();
	}
	...
	public void SwipeRailIOS(By byLocator, String Direction) throws Exception {
		...
		if (Direction.equalsIgnoreCase("Left")) {
			...
			touchAction.press(PointOption.point(sizex2, sizey2))
					.waitAction(WaitOptions.waitOptions(Duration.ofMillis(2000)))
					.moveTo(PointOption.point(sizex, sizey2)).release().perform();
			...
			touchAction.press(PointOption.point(sizex, sizey2))
					.waitAction(WaitOptions.waitOptions(Duration.ofMillis(2000)))
					.moveTo(PointOption.point(sizex2, sizey2)).release().perform();
...
//---------------------------mahesh iOS-----------------------------------------------------------------------
	...
	public boolean waitForElementDisplayedFastPolling(By byLocator, int seconds, String message)
			throws InterruptedException {
		for (int time = 0; time <= seconds; time++) {
			try {
	...
	public void LongPressOnElementiOS(WebElement element, int k) {
		...
		for (int i = 1; i <= k; i++) {
			...
			// touchAction.tap(new
			// TapOptions().withElement(ElementOption.element(element))).perform();
			logger.info("Tapped on element for " + i + " time");
			extent.extentLogger("", "Tapped on element for " + i + " time");
		}
	}
...
//	
	public void VerifyScrollOfDatePickerDown() {
		WebElement month1 = getDriver().findElement(By.xpath(
				"(//*[@class='android.widget.NumberPicker'])[1]//*[@id='numberpicker_input']//preceding-sibling::*"));
		...
		/*
		 * WebElement month3=getDriver().findElement(By.xpath(
		 * "(//*[@class='android.widget.NumberPicker'])[1]//*[@id='numberpicker_input']//following-sibling::*"
		 * )); int month3x=month3.getLocation().getX(); int
		 * month3y=month3.getLocation().getY(); int
		 * month3Width=month3.getSize().getWidth(); int
		 * month3Height=month3.getSize().getHeight(); int
		 * month3MidX=month3x+(month3Width/2); int month3MidY=month3y+(month3Height/2);
		 */
	...
	public void VerifyScrollOfMonthPickerDown() {
		WebElement month1 = getDriver().findElement(By.xpath(
				"(//*[@class='android.widget.NumberPicker'])[2]//*[@id='numberpicker_input']//preceding-sibling::*"));
		int month1x = month1.getLocation().getX();
		int month1y = month1.getLocation().getY();
		int month1Width = month1.getSize().getWidth();
		int month1Height = month1.getSize().getHeight();
	...
	public void VerifyScrollOfMonthPickerUp() {
		WebElement month1 = getDriver().findElement(By.xpath(
				"(//*[@class='android.widget.NumberPicker'])[2]//*[@id='numberpicker_input']//following-sibling::*"));
		int month1x = month1.getLocation().getX();
		int month1y = month1.getLocation().getY();
		int month1Width = month1.getSize().getWidth();
		int month1Height = month1.getSize().getHeight();
	...
	public void VerifyScrollOfYearPickerDown() {
		WebElement month1 = getDriver().findElement(By.xpath(
				"(//*[@class='android.widget.NumberPicker'])[3]//*[@id='numberpicker_input']//preceding-sibling::*"));
		int month1x = month1.getLocation().getX();
		int month1y = month1.getLocation().getY();
		int month1Width = month1.getSize().getWidth();
		int month1Height = month1.getSize().getHeight();
	...
	public void VerifyScrollOfYearPickerUp() {
		WebElement month1 = getDriver().findElement(By.xpath(
				"(//*[@class='android.widget.NumberPicker'])[3]//*[@id='numberpicker_input']//following-sibling::*"));
		int month1x = month1.getLocation().getX();
		int month1y = month1.getLocation().getY();
		int month1Width = month1.getSize().getWidth();
		int month1Height = month1.getSize().getHeight();
	...
	public void swipeRail(By byLocator, String direction, int k) {
		...
		for (int i = 1; i <= k; i++) {
			if (direction.equalsIgnoreCase("Left")) {
				...
				action.press(PointOption.point(startx, requiredy))
						.waitAction(WaitOptions.waitOptions(Duration.ofMillis(1000)))
	...
	public boolean TimeStampwaitForElementDisplayediOS(By byLocator, int seconds, String message)
			throws InterruptedException {
		for (int time = 0; time <= seconds; time++) {
			try {
				Thread.sleep(500);
	...
	public boolean TimeStampverifyElementPresent(By byLocator, String validationtext) throws Exception {
		...
		try {
			...
			softAssert.assertEquals(element.isDisplayed(), true, "" + validationtext + " " + " is displayed");
			logger.info(validationtext + " is displayed");
			// extent.extentLoggerPass("checkElementPresent", validationtext + " is
			// displayed");
			return true;
		} catch (Exception e) {
			softAssert.assertEquals(false, true, validationtext + " " + " is not displayed");
//			softAssert.assertAll();
			logger.error(validationtext + " is not displayed");
			// extent.extentLoggerFail("checkElementPresent", validationtext + " is not
			// displayed");
			return false;
		}
	}
...
//							"Swiping screen in " + " " + dire + " direction" + " " + (j + 1) + " times");
	...
	public void scrollToElement(String text) {
			...
			MobileElement el = (MobileElement)getDriver().findElement(MobileBy.className("XCUIElementTypePickerWheel"));
			el.setValue(text);
		}
	
	public void iOSSwipeUp() {
